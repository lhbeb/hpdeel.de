      ...
      <section id="featured" className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Empfohlene Produkte</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Entdecken Sie unsere sorgfältig ausgewählte Kollektion hochwertiger Elektronik und Fotogeräte.
            </p>
          </div>
